...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 616, 330))
        ...
        self.gridLayout_2.addWidget(self.plainTextEditTattoos, 1, 1, 1, 1)
        self.labelUrl = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelUrl.setObjectName("labelUrl")
        self.gridLayout_2.addWidget(self.labelUrl, 2, 0, 1, 1)
        self.labelComment = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelComment.setObjectName("labelComment")
        self.gridLayout_2.addWidget(self.labelComment, 0, 0, 1, 1)
        self.plainTextEditComment = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents)
        self.plainTextEditComment.setObjectName("plainTextEditComment")
        self.gridLayout_2.addWidget(self.plainTextEditComment, 0, 1, 1, 1)
