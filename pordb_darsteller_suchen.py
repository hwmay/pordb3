...
#
# Created: Tue Aug  4 22:27:26 2015
...
class Ui_DarstellerSuche(object):
    def setupUi(self, DarstellerSuche):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/female.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheGeschlecht.addItem(icon1, _fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/male.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheGeschlecht.addItem(icon2, _fromUtf8(""))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/white.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheEthnic.addItem(icon3, _fromUtf8(""))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/yellow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheEthnic.addItem(icon4, _fromUtf8(""))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/black.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheEthnic.addItem(icon5, _fromUtf8(""))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/brown.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheEthnic.addItem(icon6, _fromUtf8(""))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/blond.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheHaar.addItem(icon7, _fromUtf8(""))
        self.comboBoxDarstellerSucheHaar.addItem(icon6, _fromUtf8(""))
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/red.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheHaar.addItem(icon8, _fromUtf8(""))
        self.comboBoxDarstellerSucheHaar.addItem(icon5, _fromUtf8(""))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/suchen.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/clear_l.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/dialog-cancel.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
