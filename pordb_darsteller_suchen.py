...
class Ui_DarstellerSuche(object):
    def setupUi(self, DarstellerSuche):
        ...
        DarstellerSuche.resize(867, 399)
        icon = QtGui.QIcon()
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("pypordb/grey.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheHaar.addItem(icon8, "")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("pypordb/red.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheHaar.addItem(icon9, "")
        self.comboBoxDarstellerSucheHaar.addItem(icon5, "")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("pypordb/bald.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerSucheHaar.addItem(icon10, "")
