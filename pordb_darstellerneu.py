...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBoxDarstellerneuGeschlecht = QtWidgets.QComboBox(self.layoutWidget)
        ...
        self.comboBoxDarstellerneuHaarfarbe = QtWidgets.QComboBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("pypordb/red.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerneuHaarfarbe.addItem(icon5, "")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("pypordb/black.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.comboBoxDarstellerneuNation = QtWidgets.QComboBox(self.layoutWidget)
        ...
        self.lineEditDarstellerneuTattoo = QtWidgets.QLineEdit(self.layoutWidget)
        ...
        self.comboBoxDarstellerneuEthnic = QtWidgets.QComboBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("pypordb/white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerneuEthnic.addItem(icon7, "")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("pypordb/yellow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBoxDarstellerneuEthnic.addItem(icon8, "")
        self.comboBoxDarstellerneuEthnic.addItem(icon6, "")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBoxDarstellerneuHaarfarbe.setItemText(2, _translate("Dialog", "r"))
        self.comboBoxDarstellerneuHaarfarbe.setItemText(3, _translate("Dialog", "s"))
