...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/transform-crop.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonBildbeschneiden.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/user-trash.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonBildloeschen.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/media-floppy.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonNeuOK.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/dialog-cancel.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonNeuCancel.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/user-trash.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("pypordb/folder.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
