...
class Dialog(QtWidgets.QDialog, Dialog):
    def __init__(self):
        ...
        self.pushButtonNext.clicked.connect(self.onNext)
        self.pushButtonBack.clicked.connect(self.onBack)
        self.pushButtonDir.clicked.connect(self.onDirectory)
        self.pushButtonZip.clicked.connect(self.onZipFile)
